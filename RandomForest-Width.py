...
# 在微博转发广度下 随机森林 预测50条数据误差  0.3691221724756605
# 读取数据
...
for n_estimators_size in n_estimators_options:
    ...
    # 使用的是repost_num=14717之前的数据和14717之后的数据进行训练
    rfc.fit(source[x_col][:14717], source['repost_num'][:14717])
    # 预测repost_num=14717之后的数据走向
    predict = rfc.predict(source[x_col][14717:])
...
plt.legend()
plt.savefig('RF-width-50.png', dpi=400, bbox_inches='tight')
plt.show()
